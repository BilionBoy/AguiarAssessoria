...
class GEstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g_estado" do
    assert_difference("GEstado.count") do
      post g_estados_url, params: { g_estado: { nome_fantasia: @g_estado.nome_fantasia, sigla: @g_estado.sigla } }
    end
  ...
  test "should update g_estado" do
    patch g_estado_url(@g_estado), params: { g_estado: { nome_fantasia: @g_estado.nome_fantasia, sigla: @g_estado.sigla } }
