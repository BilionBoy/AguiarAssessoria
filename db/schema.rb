...
ActiveRecord::Schema[7.2].define(version: 2025_12_05_135421) do
  ...
  create_table "e_metas", force: :cascade do |t|
    t.bigint "e_empresa_id", null: false
    t.bigint "user_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["e_empresa_id"], name: "index_e_metas_on_e_empresa_id"
    t.index ["user_id"], name: "index_e_metas_on_user_id"
  end
  ...
  add_foreign_key "e_metas", "e_empresas"
  add_foreign_key "e_metas", "users"
